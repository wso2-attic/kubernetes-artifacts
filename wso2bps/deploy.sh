...
echo "Deploying BPS database Service..."
kubectl create -f "mysql-bpsdb-service.yaml"

echo "Deploying BPS database Replication Controller..."
kubectl create -f "mysql-bpsdb-controller.yaml"
