...
Building WSO2 Data Services Server Docker images using Puppet for Kubernetes:
  ...
  This will build the default profile of WSO2 Data Services Server 3.5.0 for Kubernetes platform, using configuration specified in Puppet. Please note it's possible to build relevant profiles of the products similarly. Refer `build.sh` script usage (`./build.sh -h`).
...
For more detailed instructions on deploying WSO2 Data Services Server on Kubernetes, please refer the wiki links under the Documentation section below.
