...
Building WSO2 Governance Registry Docker images using Puppet for Kubernetes:
  ...
  This will build the default profile of WSO2 Governance Registry 5.1.0 for Kubernetes platform, using configuration specified in Puppet. Please note it's possible to build relevant profiles of the products similarly. Refer `build.sh` script usage (`./build.sh -h`).
